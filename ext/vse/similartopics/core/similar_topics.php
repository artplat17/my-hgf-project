		...
		foreach ($rowset as $row)
		{
			...
			if ($this->auth->acl_get('f_read', $similar_forum_id))
			{
				...
				$topic_row = array(
					...
					'FIRST_POST_TIME'			=> $this->user->format_date($row['topic_time'], '|d M Y|'),
					...
					'LAST_POST_TIME_RS' 		=> $this->user->format_date($row['topic_last_post_time'], '|d M Y|'),
					'LAST_POST_TIME_RS_RFC3339' => gmdate(DATE_RFC3339, $row['topic_last_post_time']),
